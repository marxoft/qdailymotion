...
#ifndef USERSREQUEST_H
#define USERSREQUEST_H
...
class QDAILYMOTIONSHARED_EXPORT UsersRequest : public Request
{
    Q_OBJECT
    
public:
    explicit UsersRequest(QObject *parent = 0);
...
private:
    Q_DISABLE_COPY(UsersRequest)
};

}

#endif // USERSREQUEST_H
