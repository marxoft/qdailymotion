...
#ifndef GROUPSREQUEST_H
#define GROUPSREQUEST_H
...
class QDAILYMOTIONSHARED_EXPORT GroupsRequest : public Request
{
    Q_OBJECT
    
public:
    explicit GroupsRequest(QObject *parent = 0);
...
private:
    Q_DISABLE_COPY(GroupsRequest)
};

}

#endif // GROUPSREQUEST_H
