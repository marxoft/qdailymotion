...
#ifndef QDAILYMOTION_STREAMSREQUEST_H
#define QDAILYMOTION_STREAMSREQUEST_H
...
class QDAILYMOTIONSHARED_EXPORT StreamsRequest : public Request
{
    Q_OBJECT
...
#endif // QDAILYMOTION_STREAMSREQUEST_H
