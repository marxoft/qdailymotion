...
class QDAILYMOTIONSHARED_EXPORT ActivitiesModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::ActivitiesRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QDailymotion::ActivitiesRequest::Error error READ error NOTIFY statusChanged)
...
public:
    ...
    ActivitiesRequest::Status status() const;
    
    ActivitiesRequest::Error error() const;
...
private:        
    Q_DECLARE_PRIVATE(ActivitiesModel)
