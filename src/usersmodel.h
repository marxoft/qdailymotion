...
class QDAILYMOTIONSHARED_EXPORT UsersModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::UsersRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QDailymotion::UsersRequest::Error error READ error NOTIFY statusChanged)
...
public:
    ...
    UsersRequest::Status status() const;
    
    UsersRequest::Error error() const;
