...
#ifndef REPORTSREQUEST_H
#define REPORTSREQUEST_H
...
class QDAILYMOTIONSHARED_EXPORT ReportsRequest : public Request
{
    Q_OBJECT
    
public:
    explicit ReportsRequest(QObject *parent = 0);
...
private:
    Q_DISABLE_COPY(ReportsRequest)
};

}

#endif // REPORTSREQUEST_H
