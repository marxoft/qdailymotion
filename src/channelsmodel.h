...
class QDAILYMOTIONSHARED_EXPORT ChannelsModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::ChannelsRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QDailymotion::ChannelsRequest::Error error READ error NOTIFY statusChanged)
