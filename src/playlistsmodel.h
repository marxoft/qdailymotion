...
class QDAILYMOTIONSHARED_EXPORT PlaylistsModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::PlaylistsRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QDailymotion::PlaylistsRequest::Error error READ error NOTIFY statusChanged)
...
public:
    ...
    PlaylistsRequest::Status status() const;
    
    PlaylistsRequest::Error error() const;
