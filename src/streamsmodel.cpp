...
/*!
    ...
    ListView {
        ...
        delegate: Text {
            ...
            text: description + " " + width + "x" + height
        }
        
        Component.onCompleted: streamsModel.list(VIDEO_ID)
    }
    \endcode
...
/*!
    \brief Retrieves a list of streams for a Dailymotion video.
    
    \sa StreamsRequest::list()
*/
void StreamsModel::list(const QString &id) {
