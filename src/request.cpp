...
/*!
    \class Request
    \brief The base class for making requests to the Dailymotion Data API.
...
/*!
    ...
    \brief The client id used when making requests to the Dailymotion Data API.
*/
...
void Request::setClientId(const QString &id) {
    ...
    qDebug() << "QDailymotion::Request::setClientId" << id;
#endif
}

/*!
    \property QString Request::clientSecret
    \brief The api key used when making requests to the Dailymotion Data API.
*/
...
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::Request::setClientSecret" << secret;
#endif
}

/*!
    \property QString Request::accessToken
    \brief The access token used when making requests to the Dailymotion Data API.
*/
...
/*!
    ...
    \brief The refresh token used when making requests to the Dailymotion Data API.
*/
...
/*!
    ...
    \brief The url used when making requests to the Dailymotion Data API.
*/
...
/*!
    ...
    \brief The headers used when making requests to the Dailymotion Data API.
*/
...
/*!
    ...
    \brief The data used when making HTTP PUT/POST requests to the Dailymotion Data API.
*/
...
/*!
    ...
    when making requests to the Dailymotion API.
...
void Request::head(bool authRequired) {
    ...
    if (d->url.isEmpty()) {
        qDebug() << "QDailymotion::Request::head(): URL is empty";
        return;
    }
...
void Request::get(bool authRequired) {
    ...
    if (d->url.isEmpty()) {
        qDebug() << "QDailymotion::Request::get(): URL is empty";
        return;
    }
...
void Request::post(bool authRequired) {
    ...
    if (d->url.isEmpty()) {
        qDebug() << "QDailymotion::Request::post(): URL is empty";
        return;
    }
...
void Request::put(bool authRequired) {
    ...
    if (d->url.isEmpty()) {
        qDebug() << "QDailymotion::Request::put(): URL is empty";
        return;
    }
...
void Request::deleteResource(bool authRequired) {
    ...
    if (d->url.isEmpty()) {
        qDebug() << "QDailymotion::Request::deleteResource(): URL is empty";
        return;
    }
...
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::RequestPrivate::setOperation " << Request::Operation(op);
#endif
}
...
void RequestPrivate::setError(Request::Error e) {
    error = e;
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::RequestPrivate::setError " << Request::Error(e);
#endif
}
...
void RequestPrivate::setErrorString(const QString &es) {
    errorString = es;
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::RequestPrivate::setErrorString " << es;
#endif
}
...
void RequestPrivate::setResult(const QVariant &res) {
    result = res;
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::RequestPrivate::setResult " << res;
#endif
}
...
QNetworkRequest RequestPrivate::buildRequest(QUrl u, bool authRequired) {
#ifdef QDAILYMOTION_DEBUG
    qDebug() << "QDailymotion::RequestPrivate::buildRequest " << u;
#endif
    ...
    if ((authRequired) && (!accessToken.isEmpty())) {
