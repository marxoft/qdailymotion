...
class QDAILYMOTIONSHARED_EXPORT CommentsModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::CommentsRequest::Status status READ status NOTIFY statusChanged)
    Q_PROPERTY(QDailymotion::CommentsRequest::Error error READ error NOTIFY statusChanged)
...
public:
    ...
    CommentsRequest::Status status() const;
    
    CommentsRequest::Error error() const;
...
private:        
    Q_DECLARE_PRIVATE(CommentsModel)
