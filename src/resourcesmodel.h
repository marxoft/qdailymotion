...
#ifndef QDAILYMOTION_RESOURCESMODEL_H
#define QDAILYMOTION_RESOURCESMODEL_H
...
class QDAILYMOTIONSHARED_EXPORT ResourcesModel : public Model
{
    Q_OBJECT
    ...
    Q_PROPERTY(QDailymotion::ResourcesRequest::Error error READ error NOTIFY statusChanged)
...
#endif // QDAILYMOTION_RESOURCESMODEL_H
